...
!
  ...
  common / approx / brea_k(npiece), coef(ncoef), l, kpm
...
!
    do iter = 1, itermx
      ...
      call bsplpp ( t, a, n, kpm, templ, brea_k, coef, l )
...
!
    ...
    do i = 1, l
      ii = ( i - 1 ) * kpm
      write ( *, '(f9.3,2x,e12.4,10e11.3)' ) brea_k(i), coef(ii+1:ii+kpm)
    end do
!
...
!
    ...
    call newnot ( brea_k, coef, l, kpm, temps, lnew, templ )
...
subroutine l2err ( iprfun, ftau, ntau,error )
